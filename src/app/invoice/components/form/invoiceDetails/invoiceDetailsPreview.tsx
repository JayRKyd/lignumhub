...
import type { InvoiceItemDetails, Item } from "@/types/types";

export const InvoiceDetailsPreview: React.FC<
  InvoiceItemDetails & { onClick?: (step: string) => void }
> = ({ note, discount, taxRate, items, currency = "USD", onClick }) => {
    ...
    >
      ...
      {items.map(({ itemDescription, amount, qty }, index) => (
        <div
          ...
          key={index}
        >
          <p className="flex truncate text-xs font-medium text-gray-600 dark:text-gray-300">
            {itemDescription}
          </p>
          <div className="pl-10 grid grid-cols-3 items-center">
            ...
            <p className="flex items-end w-full text-xs font-medium text-gray-600 dark:text-gray-300 text-right justify-end">
      ...
      <div className="grid grid-cols-2">
        ...
        <div>
          ...
          <div className="flex justify-between items-center px-10 py-3">
            ...
            <p className="flex truncate text-md font-medium dark:text-gray-100">
              {currencyDetails?.currencySymbol}
