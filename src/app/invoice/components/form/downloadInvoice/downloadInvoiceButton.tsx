...
import { PdfDetails } from "@/app/invoice/components/form/pdfDetails";
import { useData } from "@/app/invoice/hooks/useData";
import { pdfContainers } from "@/lib/invoice/pdfStyles";
import { saveAs } from "file-saver";
import { pdf } from "@react-pdf/renderer";
import { svgToDataUri } from "@/lib/invoice/svgToDataUri";
...
export const DownloadInvoiceButton = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-208px)] justify-center items-center">
      <div>
        <h1 className="text-5xl font-semibold pb-6 dark:text-gray-100">Your invoice is ready</h1>
        ...
        <Button
          ...
          type="button"
          className="w-full h-12 rounded-lg text-lg bg-orange-500 hover:bg-orange-600"
        >
