...
import type { InvoiceTerms } from "@/types/types";
...
> = ({ invoiceNumber, issueDate, dueDate, onClick }) => (
  ...
  >
    ...
    <div>
      ...
      <p className="font-medium text-xs dark:text-gray-100">{invoiceNumber}</p>
    </div>
    <div className="flex items-center justify-between pl-10">
      <div>
        ...
        <p className="font-medium text-xs dark:text-gray-100">
