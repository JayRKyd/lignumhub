    ...
    <Controller
      render={({ field: { onChange, value } }) => (
        <div className="flex group items-center relative h-[52px]">
          <Popover onOpenChange={setOpen} open={open}>
            <PopoverTrigger asChild className="w-full">
              <button className="flex gap-2 items-center justify-between w-full">
                ...
                <div className="flex gap-2 items-center text-sm dark:text-gray-100">
          ...
          <div
            className={`absolute border-dashed inset-x-0 bottom-0 border-t border-gray-300 dark:border-gray-600 group-focus:border-t ${
