      ...
      render={({ field: { onChange, value } }) => {
        ...
        return (
          <div className="flex group items-center relative h-[52px]">
            <Popover open={open} onOpenChange={setOpen}>
              <PopoverTrigger asChild className="w-full">
                <button className="flex gap-2 items-center justify-between w-full">
                  <label className="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-100 whitespace-nowrap">
                    Currency
                  </label>
                  <div className="flex gap-1.5 bg-neutral-100 dark:bg-neutral-800 text-sm pl-2 pr-2.5 rounded-full py-0.5 items-center">
                    {currencyDetails && (
              ...
              <PopoverContent className="w-full p-0 PopoverContent mt-3">
                <Command className="w-full">
                  <CommandInput
                    ...
                    className="peer block w-full border-0 py-1.5 text-gray-900 dark:text-gray-100 focus:ring-0 sm:text-sm sm:leading-6 placeholder:text-neutral-700/40 placeholder:font-medium caret-orange-500"
                  />
            ...
            <div
              className={`absolute inset-x-0 bottom-0 border-t border-gray-300 dark:border-gray-600 group-focus:border-t border-dashed ${
